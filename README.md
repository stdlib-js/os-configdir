...
```bash
npm install -g @stdlib/os-configdir
```
...
[test-image]: https://github.com/stdlib-js/os-configdir/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/os-configdir/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/os-configdir
