...
```javascript
configdir = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/os-configdir@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/os-configdir@umd/bundle.js"></script>
```
